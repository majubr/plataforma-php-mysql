...
<br>
    ...
    <p align="left" class="display-5 mb-4" style="font-size: 20px"> Primeiramente insira as duas abas da planilha DarwinCore </p>
                  <form action= "importar_herpeto_oc_conversao.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="checkbox" >
             ...
             <form action= "importar_herpeto_dw_conversao.php" method="POST" enctype="multipart/form-data">
            ...
            <p align="left" class="display-5 mb-4" style="font-size: 20px"> Clique abaixo para conversão para tabela de dados analitica </p>
             <form action= "inserir_herpeto_conversao.php" method="POST" enctype="multipart/form-data">
    ...
    <br>
   <div align="center">
  <a href="manipulacao_herpeto.php" role="button" class="btn btn-light btn-lg"> Voltar </a>
</div>
<br>
