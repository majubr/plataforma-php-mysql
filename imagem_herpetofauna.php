...
if (isset($_GET['sp'])) {
    ...
    $sql = "SELECT * FROM herpeto_imagens WHERE sp = :sp";
    ...
    if (!$row) {
        ...
        $image_path = $row['path'];
        $full_image_path = 'imagens_herpetofauna/' . $image_path;
...
<br>
<div align="center">
  <a href="dash_herpeto.php?pagina=especie" role="button" class="btn btn-light btn-lg"> Voltar </a>
</div>
<br>
