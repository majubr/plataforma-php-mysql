...
mysqli_query($conn, "SET CHARACTER SET utf8");
    ...
    $query = "SELECT eventID, samplingProtocol, samplingEffort, sampleSizeValue, sampleSizeUnit, eventDate, eventRemarks, county, municipality, waterBody, locality, decimalLatitude, decimalLongitude, geodeticDatum from dw_resgate ORDER BY id DESC";  
