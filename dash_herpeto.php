...
<?php include 'header.php' ?>
      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block sidebar" style='background-color:#f6f5f4;border-right: 1px solid #f3f3f3'>
          <div class="sidebar-sticky" class="display-5 mb-4" style="font-size: 19px">
            ...
            <ul class="nav flex-column" style="padding-top: 20px">
              <li class="nav-item">
                <a class="nav-link" href="?pagina=painel_herpeto" style="color:#000;text-decoration: none">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?pagina=abundancia_herpeto" style="color:#000;text-decoration: none">

                  <i class="fa-solid fa-chart-line"></i>&nbsp&nbspGráfico - Espécies
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="?pagina=familia_herpeto" style="color:#000;text-decoration: none">

                  <i class="fa-solid fa-chart-line"></i>&nbsp&nbspGráfico - Familias
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="?pagina=ordem_herpeto" style="color:#000;text-decoration: none">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?pagina=regiao_herpeto" style="color:#000;text-decoration: none">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?pagina=campanha_herpeto" style="color:#000;text-decoration: none">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?pagina=estacao_herpeto" style="color:#000;text-decoration: none">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?pagina=opcoes_herpeto" style="color:#000;text-decoration: none">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h4 class="display-5 mb-4" style="font-size: 30px">Dashboard Herpetofauna</h4>
  ...
  <br>
  <div align="center">
    <a href="lista_sp_herpetofauna.php" role="button" class="btn btn-light btn-lg"> Ir para tabela de dados </a>
       <br>
    <br>
