...
<body >
	  ...
	  <div align="left">  
      <p class="display-5 mb-4" style="font-size: 30px"> Descrição quantitativa da tabela de valor de mastofauna </p>
  	  <br>
  	</div>
				...
				<div class="card text-white bg-secondary mb-3" style="max-width: 18rem;" id="sombra">
					...
					<div class="card-body" >
						...
						<?php
							...
							$sql = "SELECT SUM(numero_ind) AS total FROM mastofauna;";
					...
					<div class="card text-white bg-secondary mb-3" style="max-width: 18rem;" id="sombra">
						...
						<div class="card-body">
							<h5 class="card-title" style="text-align: center;font-size: 40px">
								...
								$sql = "SELECT COUNT(distinct(ponto_amostral)) AS total FROM mastofauna";
								$stmt = $conn->prepare($sql);
								$stmt->execute();
								$row = $stmt->fetch(PDO::FETCH_ASSOC);
$valor = $row['total'];  // Correctly assign the single value to $valor
						...
						<div class="card text-white bg-secondary mb-3" style="max-width: 18rem;" id="sombra">
							...
							<div class="card-body">
								<h5 class="card-title" style="text-align: center;font-size: 40px">
									...
									$sql = "SELECT COUNT(distinct(campanha)) AS total FROM mastofauna";
									$stmt = $conn->prepare($sql);
								$stmt->execute();
								$row = $stmt->fetch(PDO::FETCH_ASSOC);
$valor = $row['total'];  // Correctly assign the single value to $valor
				...
				<div class="card text-white bg-success mb-3" style="max-width: 18rem;" id="sombra">
					...
					<div class="card-body" >
						<h5 class="card-title" style="text-align: center;font-size: 40px">
							...
							$sql = "SELECT COUNT(distinct(especie)) AS total FROM mastofauna";
							$stmt = $conn->prepare($sql);
							$stmt->execute();
							$row = $stmt->fetch(PDO::FETCH_ASSOC);
							$valor = $row['total'];  // Correctly assign the single value to $valor
					...
					<div class="card text-white bg-success mb-3" style="max-width: 18rem;" id="sombra">
						...
						<div class="card-body">
							<h5 class="card-title" style="text-align: center;font-size: 40px">
								...
								$sql = "SELECT COUNT(distinct(familia)) AS total FROM mastofauna";
								$stmt = $conn->prepare($sql);
								$stmt->execute();
								$row = $stmt->fetch(PDO::FETCH_ASSOC);
								$valor = $row['total'];  // Correctly assign the single value to $valor
						...
						<div class="card text-white bg-success mb-3" style="max-width: 18rem;" id="sombra">
							...
							<div class="card-body">
								<h5 class="card-title" style="text-align: center;font-size: 40px">
									...
									$sql = "SELECT COUNT(distinct(ordem)) AS total FROM mastofauna";
									$stmt = $conn->prepare($sql);
								$stmt->execute();
								$row = $stmt->fetch(PDO::FETCH_ASSOC);
$valor = $row['total'];  // Correctly assign the single value to $valor
				...
				<div class="card text-white bg-danger mb-3" style="max-width: 18rem;" id="sombra">
					...
					<div class="card-body" >
						<h5 class="card-title" style="text-align: center;font-size: 40px">
							...
							$sql = "SELECT COUNT(distinct(especie)) AS total FROM mastofauna WHERE mg != 'NA' and mg !='LC'";
							$stmt = $conn->prepare($sql);
							$stmt->execute();
							$row = $stmt->fetch(PDO::FETCH_ASSOC);
							$valor = $row['total'];  // Correctly assign the single value to $valor
					...
					<div class="card text-white bg-danger mb-3" style="max-width: 18rem;" id="sombra">
						...
						<div class="card-body">
							<h5 class="card-title" style="text-align: center;font-size: 40px">
								...
								$sql = "SELECT COUNT(distinct(especie)) AS total FROM mastofauna WHERE br != 'NA' and br !='LC'";
								$stmt = $conn->prepare($sql);
								$stmt->execute();
								$row = $stmt->fetch(PDO::FETCH_ASSOC);
								$valor = $row['total'];  // Correctly assign the single value to $valor
						...
						<div class="card text-white bg-danger mb-3" style="max-width: 18rem;" id="sombra">
							...
							<div class="card-body">
								<h5 class="card-title" style="text-align: center;font-size: 40px">
									...
									$sql   =  "SELECT COUNT(distinct(especie)) AS total FROM mastofauna WHERE iucn != 'LC' and  iucn != '-' ";
									$stmt = $conn->prepare($sql);
								$stmt->execute();
								$row = $stmt->fetch(PDO::FETCH_ASSOC);
								$valor = $row['total'];  // Correctly assign the single value to $valor
