...
<?php include 'header.php' ?>
    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-md-2 d-none d-md-block sidebar" style='background-color:#f6f5f4;border-right: 1px solid #f3f3f3'>
          <div class="sidebar-sticky" class="display-5 mb-4" style="font-size: 19px">
            ...
            <ul class="nav flex-column" style="padding-top: 20px">
              <li class="nav-item">
                <a class="nav-link" href="?pagina=painel_avi" style="color:#000;text-decoration: none">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?pagina=abundancia_avi" style="color:#000;text-decoration: none">

                  <i class="fa-solid fa-chart-line"></i>&nbsp&nbspGráfico - Espécies
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="?pagina=familia_avi" style="color:#000;text-decoration: none">

                  <i class="fa-solid fa-chart-line"></i>&nbsp&nbspGráfico - Familias
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="?pagina=ordem_avi" style="color:#000;text-decoration: none">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?pagina=regiao_avi" style="color:#000;text-decoration: none">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?pagina=campanha_avi" style="color:#000;text-decoration: none">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?pagina=estacao_avi" style="color:#000;text-decoration: none">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?pagina=opcoes_avi" style="color:#000;text-decoration: none">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <h4 class="display-5 mb-4" style="font-size: 30px">Dashboard Avifauna</h4>
  ...
  <br>
  <div align="center">
    <a href="lista_sp_avifauna.php" role="button" class="btn btn-light btn-lg"> Ir para tabela de dados </a>
    <br>
    <br>
