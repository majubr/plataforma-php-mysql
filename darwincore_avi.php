...
<div  class = 'container' style="margin-top:40px">
  ...
  <div align="left">  
      <h1 class="display-5 mb-4">Planilha Darwincore - avifauna</h1>
      <br>
  </div>
...
<table id="tabela2"  class="display" style="width:100%">
  ...
  <a href="lista_sp_avifauna.php" role="button" class = "btn btn-sm btn-primary"> Voltar </a>
