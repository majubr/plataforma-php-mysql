...
<div  class = 'container' style="margin-top:40px">
        ...
        <div align="left">  
      <p class="display-5 mb-4" align ="center" style="font-size: 30px"> Manipulação de tabelas - resgate </p>
      <br>
...
<div class="row">
  <div class="col-sm-6">
   ...
   <form action= "importar_resgate_oc.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="checkbox" >
                <label><input type="file" name="file" ></label>
                    ...
                    <form method="post" action="exportar_resgate_oc.php" align="left">  
                <input type="submit" name="exportar" value="Exportar planilha (aba) Associated Occurences - arquivo .xlsx" class="btn btn-outline-success " />  
                 ...
                 <form action= "importar_resgate_dw.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="checkbox" >
                ...
                <form method="post" action="exportar_resgate_dw.php" align="left">  
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
           <form action= "importar_resgate.php" method="POST" enctype="multipart/form-data">
    <p align="left" class="display-5 mb-4" style="font-size: 30px"> Tabela de dados para analises - importaçao e exportação </p>
            ...
            <div class="checkbox" >
                ...
                <form method="post" action="exportar_resgate.php" align="left">  
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div align="center" class="card-body"> 
                  <form action= "conversao_darwin_resgate.php" method="POST" enctype="multipart/form-data">
                    ...
                    <p></p>
                    <a href = "conversao_darwin_resgate.php"> <img src="conversao.png"></a>
  ...
  <div class="col-sm-6">
    ...
    <br>
   <div align="center">
  <a href="lista_sp_resgate.php" role="button" class="btn btn-light btn-lg"> Voltar </a>
</div>
<br>
