...
?>
            ...
            <h4 class="display-5 mb-4">Galeria de imagens da herpetofauna</h4>

            <p>Clique na imagem para aumentar e realizar download</p>

            <div class="row">
                <?php
                $fotos_dir = "imagens_herpetofauna/";
                ...
                foreach ($fotos as $foto) {
                    ...
                    $sql = "SELECT especie, nome_popular FROM herpetofauna WHERE especie='$sp'";
