...
<body>
<br>
<p class="display-5 mb-4" style="font-size: 30px">Lista de espécies ameaçadas da avifauna</p>
...
<table class="table">
	...
	<?php
		...
		$sql = "SELECT DISTINCT especie, nome_popular, familia, mg, br, iucn, COUNT(numero_ind) AS total FROM avifauna WHERE especie LIKE '%$searchTerm%' AND (mg != 'NA' or br != 'NA' or iucn != 'NA') AND (mg != '-' or br != '-' or iucn !='-' ) AND ( iucn !='LC' ) AND (mg != ' ' or br != ' ' or iucn != ' ')  GROUP BY especie";
