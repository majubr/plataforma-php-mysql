...
<body>
<br>
<p class="display-5 mb-4" style="font-size: 30px">Lista de espécies ameaçadas da resgate</p>
...
<table class="table">
	...
	<?php
		...
		$sql = "SELECT DISTINCT especie, nome_popular, familia, mg, br, iucn, COUNT(numero_ind) AS total FROM resgate WHERE especie LIKE '%$searchTerm%' AND (mg != 'NA' or br != 'NA' or iucn != 'LC') AND iucn != 'NA' AND iucn != '-' GROUP BY especie";
