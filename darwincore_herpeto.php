...
$(document).ready(function() {
    $('#tabela1').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "listar_herpeto_darwin.php",
        "language": {
    ...
    $('#tabela2').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "listar_herpeto_darwin_oc.php",
        "language": {
            "url": "//cdn.datatables.net/plug-ins/1.11.5/i18n/pt-BR.json"
        }
    }
 ...
 $('#tabela3').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "listar_herpeto_darwin_re.php",
        "language": {
            "url": "//cdn.datatables.net/plug-ins/1.11.5/i18n/pt-BR.json"
        }
    })
...
<div  class = 'container' style="margin-top:40px">
  ...
  <div align="left">  
      <h1 class="display-5 mb-4">Planilha Darwincore - herpetofauna</h1>
      <br>
  </div>
...
<table id="tabela2"  class="display" style="width:100%">
  ...
  <a href="lista_sp_herpetofauna.php" role="button" class = "btn btn-sm btn-primary"> Voltar </a>
