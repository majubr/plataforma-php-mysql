...
<br>
<br>
<form action="resultado_sp_masto.php" method="post">
<select class="form-control" name="especie">

<?php 

   
        $sql = "SELECT distinct(especie) as sp FROM mastofauna ORDER BY especie";
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>
 ...
 <div align="center">
                  <a href="dash_masto.php?pagina=opcoes_masto" role="button" class = "btn btn-light btn-lg"> Voltar </a>
      </div>
  </body>
<br>
<br>
