...
$sql =  "SELECT familia, count(familia) as numero  FROM mastofauna GROUP BY familia";
...
$sql =  "SELECT familia, count(familia) as numero  FROM mastofauna WHERE ano='2018' GROUP BY familia";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql =  "SELECT familia, count(familia) as numero  FROM mastofauna WHERE ano='2019' GROUP BY familia";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
function updateChartType4() {
	...
	<?php
$sql =  "SELECT familia, count(familia) as numero  FROM mastofauna WHERE ano='2020' GROUP BY familia";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
if (document.getElementById('chartValor').value = '2020') 
  ...
  events: [],
	...
	function updateChartType5() {
			<?php
$sql =  "SELECT familia, count(familia) as numero  FROM mastofauna WHERE ano='2021' GROUP BY familia";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql =  "SELECT familia, count(familia) as numero  FROM mastofauna WHERE ano='2022' GROUP BY familia";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql =  "SELECT familia, count(familia) as numero  FROM mastofauna WHERE ano='2023' GROUP BY familia";
$stmt = $conn->prepare($sql);
$stmt->execute();
