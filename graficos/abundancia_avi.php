...
$sql =  "SELECT nome_popular, count(nome_popular) as numero  FROM avifauna GROUP BY nome_popular";
...
while ($array = $stmt->fetch(PDO::FETCH_ASSOC)) {
 $nome_popular = $nome_popular . '"' . $array['nome_popular'] . '",';
	 $numero = $numero . '"' . $array['numero'] . '",';

	 $nome_popular = trim($nome_popular); #tira os espaços da variável
	 $numero = trim($numero);
  ...
  events: [],
    ...
    datalabels: {
      ...
      formatter: function(value, context) {
        return value; // Show bar values on top of the bars
      }
    }
  },
...
$sql =  "SELECT nome_popular, count(nome_popular) as numero  FROM avifauna WHERE ano='2018' GROUP BY nome_popular";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
if (document.getElementById('chartValor').value = '2018') 
    ...
    data:  {
		tooltips: {
    enabled: false // This disables the tooltips on hover
  },
					labels:[<?php echo $nome_popular; ?>],
					datasets:
					[{
...
$sql =  "SELECT nome_popular, count(nome_popular) as numero  FROM avifauna WHERE ano='2019' GROUP BY nome_popular";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
function updateChartType4() {
	...
	<?php
$sql =  "SELECT nome_popular, count(nome_popular) as numero  FROM avifauna WHERE ano='2020' GROUP BY nome_popular";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
if (document.getElementById('chartValor').value = '2020') 
  ...
  events: [],
	...
	function updateChartType5() {
			<?php
$sql =  "SELECT nome_popular, count(nome_popular) as numero  FROM avifauna WHERE ano='2021' GROUP BY nome_popular";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql =  "SELECT nome_popular, count(nome_popular) as numero  FROM avifauna WHERE ano='2022' GROUP BY nome_popular";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql =  "SELECT nome_popular, count(nome_popular) as numero  FROM avifauna WHERE ano='2023' GROUP BY nome_popular";
$stmt = $conn->prepare($sql);
$stmt->execute();
