...
$sql =  "SELECT ordem, count(ordem) as numero  FROM ictiofauna GROUP BY ordem";
...
$sql =  "SELECT ordem, count(ordem) as numero  FROM ictiofauna WHERE ano='2018' GROUP BY ordem";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql =  "SELECT ordem, count(ordem) as numero  FROM ictiofauna WHERE ano='2019' GROUP BY ordem";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
function updateChartType4() {
	...
	<?php
$sql =  "SELECT ordem, count(ordem) as numero  FROM ictiofauna WHERE ano='2020' GROUP BY ordem";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
if (document.getElementById('chartValor').value = '2020') 
  ...
  events: [],
	...
	function updateChartType5() {
			<?php
$sql =  "SELECT ordem, count(ordem) as numero  FROM ictiofauna WHERE ano='2021' GROUP BY ordem";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql =  "SELECT ordem, count(ordem) as numero  FROM ictiofauna WHERE ano='2022' GROUP BY ordem";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql =  "SELECT ordem, count(ordem) as numero  FROM ictiofauna WHERE ano='2023' GROUP BY ordem";
$stmt = $conn->prepare($sql);
$stmt->execute();
