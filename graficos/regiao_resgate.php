...
$sql =  "SELECT regiao, count(regiao) as numero  FROM resgate GROUP BY regiao";
...
$sql =  "SELECT regiao, count(regiao) as numero  FROM resgate WHERE ano='2018' GROUP BY regiao";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql =  "SELECT regiao, count(regiao) as numero  FROM resgate WHERE ano='2019' GROUP BY regiao";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
function updateChartType4() {
	...
	<?php
$sql =  "SELECT regiao, count(regiao) as numero  FROM resgate WHERE ano='2020' GROUP BY regiao";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
if (document.getElementById('chartValor').value = '2020') 
  ...
  events: [],
	...
	function updateChartType5() {
			<?php
$sql =  "SELECT regiao, count(regiao) as numero  FROM resgate WHERE ano='2021' GROUP BY regiao";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql =  "SELECT regiao, count(regiao) as numero  FROM resgate WHERE ano='2022' GROUP BY regiao";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql =  "SELECT regiao, count(regiao) as numero  FROM resgate WHERE ano='2023' GROUP BY regiao";
$stmt = $conn->prepare($sql);
$stmt->execute();
