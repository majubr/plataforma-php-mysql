...
if (isset($_GET['sp'])) {
    ...
    $sql = "SELECT * FROM ictio_imagens WHERE sp = :sp";
    ...
    if (!$row) {
        ...
        $image_path = $row['path'];
        $full_image_path = 'imagens_ictiofauna/' . $image_path;
...
<br>
<div align="center">
  <a href="dash_ictio.php?pagina=especie" role="button" class="btn btn-light btn-lg"> Voltar </a>
</div>
<br>
