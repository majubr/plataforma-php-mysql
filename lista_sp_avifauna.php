...
<div class='container' style="margin-top:40px">
    ...
    <div align="left">
        <h1 class="display-5 mb-4">Tabela de dados - avifauna</h1>
        <br>
    </div>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <div>
                    <a href="dash_avi.php?pagina" role="button" class="btn btn-outline-success btn-lg"> Ir para Dashboard avifauna </a>
                </div>
                <br>
                <div>
                    <a href="darwincore_avi.php" role="button" class="btn btn-outline-success btn-lg"> Ir para planilha DarwinCore </a>
                </div>
                <br>
                <div>
            ...
            <div class="col-md-6">
                <div>
                    <div>
                        <div align="right">
                            <a href="dash_avi.php?pagina"> <img class="d-block w-100" src="img/dash.png"></a>
                        </div>
                    </div>
                </div>
            </div>
