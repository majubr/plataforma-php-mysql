...
if($extensao  != "csv"){
	...
	while (($dados = fgetcsv($objeto, 10000, ";")) !== FALSE){
		...
		$query = "INSERT INTO dw_avifauna_conversao (eventID, samplingProtocol, samplingEffort, sampleSizeValue, sampleSizeUnit, eventDate, eventRemarks, county, municipality, waterBody, locality, decimalLatitude, decimalLongitude, geodeticDatum) VALUES ('$eventID','$samplingProtocol','$samplingEffort','$sampleSizeValue','$sampleSizeUnit','$eventDate','$eventRemarks','$county','$municipality','$waterBody','$locality','$decimalLatitude','$decimalLongitude','$geodeticDatum')";
