...
?>
            ...
            <h4 class="display-5 mb-4">Galeria de imagens da mastofauna</h4>

            <p>Clique na imagem para aumentar e realizar download</p>

            <div class="row">
                <?php
                $fotos_dir = "imagens_mastofauna/";
                ...
                foreach ($fotos as $foto) {
                    ...
                    $sql = "SELECT especie, nome_popular FROM mastofauna WHERE especie='$sp'";
