...
<body>
	<h3>Arquivo inserido com sucesso</h3> 
	<br>

        <a href="manipulacao_herpeto.php" role="button" class = "btn btn-success btn-lg"> Voltar para manipulação de tabelas </a>
